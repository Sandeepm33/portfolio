...
function Activity() { return <section className="section activity"><motion.div className="activity-card" {...reveal}><div className="activity-top"><div><div className="section-label">06 / Builder&apos;s log</div><h2>Steady craft,<br /><span>visible progress.</span></h2></div><div className="live-dot"><i /> active</div></div><div className="activity-grid"><div className="contributions"><div className="contribution-head"><span>Contribution rhythm</span><small>Designed snapshot · not live GitHub data</small></div><div className="heatmap">{Array.from({ length: 84 }, (_, i) => <i key={i} className={`l${(i * 7 + i % 5) % 5}`} />)}</div><div className="heat-legend">Less <i className="l0" /><i className="l1" /><i className="l2" /><i className="l3" /><i className="l4" /> More</div></div><div className="activity-stats"><div><strong>6</strong><small>featured products</small></div><div><strong>2.1</strong><small>years experience</small></div><div><strong>4</strong><small>domains explored</small></div></div></div></motion.div></section> }
